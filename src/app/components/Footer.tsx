    ...
    <footer className="bg-brand-dark text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="font-bold text-lg mb-4 font-montserrat">{profession}</h3>
            <p className="text-brand-dark-muted text-sm">
          ...
          <div>
            <h3 className="font-bold text-lg mb-4 font-montserrat">Contact</h3>
            <div className="space-y-2 text-sm">
              <p className="text-brand-dark-muted">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-brand-dark-muted">
              <p>Travail soigné</p>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-sm text-brand-dark-muted">
